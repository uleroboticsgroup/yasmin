...
* fix: dereference node pointer for TransformBroadcaster initialization in publish_tf_loop
* refactor: add brief documentation comments for action and service state classes
...
* refactor: remove unnecessary blank lines in ROSClientsCache class
