...
PALETTES = {
    DEFAULT_PALETTE_NAME: EditorPalette(
        ...
        shell_bg=_color(248, 248, 248),
        shell_text=_color(24, 24, 24),
        shell_border=_color(176, 176, 176),
        shell_selection_bg=_color(65, 110, 185),
        shell_selection_text=_color(255, 255, 255),
        shell_prompt_in=_color(21, 101, 192),
        shell_prompt_out=_color(46, 125, 50),
        shell_comment=_color(96, 107, 121),
        shell_keyword=_color(123, 31, 162),
        shell_string=_color(2, 119, 189),
        shell_number=_color(239, 108, 0),
        shell_error=_color(181, 51, 51),
    ...
    DARKMODE_PALETTE_NAME: EditorPalette(
        ...
        shell_bg=_color(24, 27, 31),
        shell_text=_color(232, 235, 239),
        shell_border=_color(78, 84, 94),
        shell_selection_bg=_color(74, 104, 155),
        shell_selection_text=_color(245, 247, 250),
        shell_prompt_in=_color(120, 190, 255),
        shell_prompt_out=_color(116, 214, 146),
        shell_comment=_color(132, 140, 150),
        shell_keyword=_color(198, 160, 255),
        shell_string=_color(120, 220, 255),
        shell_number=_color(255, 190, 110),
        shell_error=_color(255, 122, 122),
